...
const cloudStoragesActions = {
    ...
    getCloudStoragesSuccess: (array: any[], count: number, query: Partial<CloudStoragesQuery>) =>
...
export function getCloudStoragesAsync(query: Partial<CloudStoragesQuery>): ThunkAction {
    return async (dispatch: ActionCreator<Dispatch>): Promise<void> => {
        ...
        dispatch(cloudStoragesActions.getCloudStoragesSuccess(array, result.count, query));
    };
}
